...
excerpt: "Nexon 데이터 분석 인턴 전형에서 과제로 진행한 내용을 정리했습니다."
...
<strong>🚫 해당 데이터셋 저작권은 'Nexon'에 귀속된 바, 상세내용은 담지 않았습니다. 어떻게 이 과제를 진행했는지에 <u>초점</u>을 두었습니다.</strong>
<br>
...
### 2. 각 서비스별로 특이사항이 있는지 찾아보고 발견한 내용을 설명하기
<ol>
...
# ✔ feature 상관관계 & 유저 분류 및 분석 진행 및 코드
